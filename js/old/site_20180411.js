...
//				d.Metadata = $.grep(meta_data, function(e){ return e.VisibilityLevel <= 99 && e.VisibilityLevel <= inform_levels });
				...
				d3.json(setting == 'api' ? url_data : 'data/inform_data_' + country_code + '.json', function(inform_data){
                    ...
                    var url_geo_direct = 'http://www.inform-index.org/DesktopModules/MVC/InformMVC/Model/' + geo_data_url + '.json';
					...
					d3.json(url_geo_direct, function(geo_data) {
						...
						var url_color = 'http://www.inform-index.org/API/InformAPI/Processes/GetColorPaletteByWorkflowId/' + workflow_id;
